...
-  two Ubuntu OS (Xenial or later) vm's(master , worker)
- `sudo` privileges
- Internet access
- higher spec vm  type or higher

---

## VM Setup

1. Ensure that all instances are in the same **Firewall**.
2. Expose port **6443** in the **firewall** to allow worker nodes to join the cluster.
3. Expose port **22** in the **Firewall** to allows SSH access to manage the instance..
